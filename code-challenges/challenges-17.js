...
const recursionPattern = (int1, int2) => {
    ...
    let arr1=[];
    let maxNum=int1;
    function myRec(int1,int2,arr)
        {
          arr.push(int1);
          if(int2>0){
            if(int1>=0)
  {        myRec(int1-int2,int2,arr)
  }          else if(arr[0]==int1){
            {
              return ;
            }
    ...
    myRec(int1,int2,arr1)
    myRec(arr1[arr1.length-2],-int2,arr1)
    return arr1;
}
// -------------------------------------------------------------------------------------------------------
...
const filterLinks = (str) => {
    // write your code here
    return str.split("").slice(str.indexOf('\/')+2,str.lastIndexOf('\"')).join("");
}
// -------------------------------------------------------------------------------------------------------
...
const isPalindrome = (str) => {
    // write your code here
    let res=str.split("").map((ele)=>{
        return ele.toLowerCase()
        }).filter((ele)=>{
        return ele >= "a" && ele<="z"?ele:'';
        }).join("");
