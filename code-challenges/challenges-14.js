...
const LastWord_2 = (str) => {
    // write your code here
    let myStr=str.split(" ");
    return myStr.slice(myStr.length - 1).join();
}
// -------------------------------------------------------------------------------------------------------
...
//
// Input: "I wa3000 years ago"s there 
...
const replaceWords = (str) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        arr.indexOf("I")!=-1?arr.splice(arr.indexOf("I"),1,"We"):"";
        arr.indexOf("was")!=-1?arr.splice(arr.indexOf("was"),1,"were"):"";
        arr.indexOf("am")!=-1?arr.splice(arr.indexOf("am"),1,"are"):"";
    }
return arr.join(" ");
}
// -------------------------------------------------------------------------------------------------------
